...
function openProjectModal(project) {
    ...
    if (project.preview) {
        ...
        projectModalState.preview.innerHTML = 'Voir le projet';
    ...
    if (project.github) {
        ...
        projectModalState.github.innerHTML = 'Consulter le code';
    } else {
...
function createProjectCard(project) {
    ...
    card.innerHTML = `
        ...
        <div class="project-content">
            ...
            <button class="btn btn-primary" type="button" aria-label="Voir le projet ${escapeHtml(project.title)}">
                Découvrir
            </button>
        </div>
    `;
